...
5. STATIC / MEANINGFUL LAYOUT: Because web layouts require a precise, static structure (e.g. hero at the top, sections in order, etc.) to render correctly, you MUST set `"static_layout": true` in the `root_metadata` object of the 'web-root' node. E.g., `"root_metadata": { "summary": "...", "tags": [], "portal_behavior": "standard", "static_layout": true }`.
