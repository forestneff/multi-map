...
const MultiMapSchema = {
    ...
    rules: {
        ...
        'file-root': { allowed: ['file-folder', 'note', 'portal', 'smart-portal', 'hub', 'logic-gate'], default: 'portal', strict: false },
        'file-folder': { allowed: ['file-folder', 'note', 'portal', 'smart-portal', 'hub', 'logic-gate'], default: 'portal', strict: false },
    ...
    mapTypes: {
        ...
        'file': { label: 'File System', rootNode: 'file-root', allowedNodes: ['file-root', 'file-folder', 'hub', 'portal', 'smart-portal', 'note', 'logic-gate', 'web-link'] },
